...
class SampleTester(TestableEstimator):
    ...
    def __init__(self, *, testImages=None, sampleEstimator: SampleEstimator, testName: str, overwrite=None):
        ...
        testImagesFilepath = FilepathUtils.get_test_images_filepath(sampleEstimator.imageProductFilepath, testName)
        ...
        testIptFilepath = FilepathUtils.get_test_ipm_filepath(sampleEstimator.imageProductFilepath, testName)
        ...
        self.testEmbeddingsFilepath = FilepathUtils.get_test_embeddings_filepath(sampleEstimator.imageProductFilepath,
                                                                                 testName)
